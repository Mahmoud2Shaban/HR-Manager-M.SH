...
class _PermissionHistoryState extends State<PermissionHistory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(child: Text("Permission History",
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Fall 2022",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Spring 2023",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                        Text("(1)",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                      ],
                    ),
                  )
